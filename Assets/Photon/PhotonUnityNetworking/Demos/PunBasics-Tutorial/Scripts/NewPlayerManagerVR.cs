...
#pragma warning disable 649
    ...
    /// </summary>
    public class NewPlayerManagerVR : MonoBehaviourPunCallbacks, IPunObservable
    {
        ...
        [Tooltip("The Player's Brush GameObject Prefab")]
        [SerializeField]
        ...
        public void Update()
        {
            ...
            if (photonView.IsMine)
            {
                ...
                // old AR else if (Input.GetTouch(0).phase == TouchPhase.Ended)
